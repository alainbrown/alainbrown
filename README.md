...
- [**stack-agent**](https://github.com/alainbrown/stack-agent): AI agent for developers to scaffold full-stack applications.
...
- [**catm**](https://github.com/alainbrown/catm): On-device long-form text-to-speech as a Chrome extension, powered by Kokoro 82M TTS in the browser — no server, no upload, no account.
- [**musicprint**](https://github.com/alainbrown/musicprint): Offline music recognition on a phone with high recall and minimal storage.
